...
b1=Button(a,text="rock",width=15,bd=0,bg="pink",pady=10)
b1.grid(row=1,column=1,pady=7,padx=7)
b2=Button(a,text="paper",width=15,bd=0,bg="pink",pady=10)
b2.grid(row=1,column=2,pady=7,padx=7)
b3=Button(a,text="scissors",width=15,bd=0,bg="pink",pady=10)
